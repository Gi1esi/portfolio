<template>
  ...
  >
    ...
    >
      <div
        v-if="menuOpen"
        class="fixed md:hidden inset-0 bg-brand-primary/80 dark:bg-gray-800/80 backdrop-blur-md text-white dark:text-gray-200 flex flex-col items-center justify-center space-y-8 text-xl font-medium z-40 w-full"
      >
        <button @click="toggleDark" class="text-xl">
          <i v-if="isDark" class="ri-moon-line"></i>
          <i v-else class="ri-sun-line"></i>
