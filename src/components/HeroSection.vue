<template>
  ...
  >
    ...
    >
      ...
      <img
        src="/images/Grace-hero2.png "
        alt="Hero background"
        class="md:block dark:hidden h-[100%] w-[100%] md:w-1/3 object-cover"
      />
      <img
        src="/images/Grace-hero-dark.png"
...
onMounted(() => {
  new Typed(typedEl.value, {
    strings: ['git clone Grace-Gausi', 'cd Grace-Gausi', 'npm run inspire'],
    typeSpeed: 80,
    backSpeed: 40,
    backDelay: 1200,
    loop: true,
