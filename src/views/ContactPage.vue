<template>
  ...
  >
    ...
    <div class="w-full max-w-lg">
      <h2 class="text-3xl font-extrabold text-brand-primary mb-10 text-center">
        Drop Me a Message
      </h2>
      ...
      >
        ...
        <button
          type="submit"
          class="bg-brand-primary text-white font-semibold py-2 px-6 rounded hover:bg-brand-primary/90 transition"
        >
          Send Mail
        </button>
      </form>
